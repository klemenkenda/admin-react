...
function (_Component) {
  ...
  function Install(props, state) {
    var _this;

    _classCallCheck(this, Install);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(Install).call(this, props));
    _this.state = {
      data: []
    };
    return _this;
  ...
  _createClass(Install, [{
    ...
    value: function render() {
      ...
      }, this.props.config.map(function (el, i) {
        return _react.default.createElement(_Module.default, {
          key: i,
          data: el
        });
      })));
